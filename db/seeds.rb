...
User.create(name: "武○製薬の開発者", email: "developer@gmail.com", password: "password", role: 1)
User.create(name: "塩○義製薬の開発者", email: "developer2@gmail.com", password: "password", role: 1)
