...
developer7 = User.create(name: "沢○製薬", email: "developer7@gmail.com", password: "password", role: 1)
...
Medicine.create(name: "セフカペンピボキシル塩酸塩錠", standard: 100, unit: 0, user_id: developer7.id)
